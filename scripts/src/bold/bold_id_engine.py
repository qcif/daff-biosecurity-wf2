...
def main():
    ...
    hits_result = BoldTaxa.bold_sequence_search(sequences)
    # print(f"Hits Result: {hits_result}")

    taxa = BoldTaxa.extract_taxa(hits_result)
    # print(f"Extracted Taxa: {taxa}")

    bold_taxa_engine = BoldTaxa(taxa)
    bold_taxa_engine.records = bold_taxa_engine._fetch_records(taxa)
...
class BoldTaxa:
    ...
    def bold_sequence_search(sequences: list[str],
